                ...
                <div class="top-bar-language tf-cur justify-content-end">
                    ...
                    <div class="tf-currencies">
                        <select class="image-select center style-default type-currencies">
                            <option data-thumbnail="{{ asset('assets/frontend/images/country/fr.svg') }}">EUR <span>€ | France</span></option>
                            <option data-thumbnail="{{ asset('assets/frontend/images/country/de.svg') }}">EUR <span>€ | Germany</span></option>
                            <option selected data-thumbnail="{{ asset('assets/frontend/images/country/us.svg') }}">USD <span>$ | United States</span></option>
                            <option data-thumbnail="{{ asset('assets/frontend/images/country/vn.svg') }}">VND <span>₫ | Vietnam</span></option>
                        </select>
                    </div>
            ...
            <div class="row wrapper-header align-items-center">
                ...
                <div class="col-xl-3 col-md-4 col-6">
                    <a href="index-2.html" class="logo-header">
                        <img src="{{ asset('assets/frontend/images/logo/logo.svg') }}" alt="logo" class="logo">
                    </a>
                </div>
                                ...
                                <div class="sub-menu mega-menu">
                                    <div class="container">
                                        <div class="row-demo">
                                            <div class="demo-item">
                                                <a href="index-2.html">
                                                    <div class="demo-image position-relative">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-01.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-01.jpg') }}" alt="home-01">
                                            ...
                                            <div class="demo-item">
                                                <a href="home-multi-brand.html">
                                                    <div class="demo-image position-relative">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-multi-brand.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-multi-brand.jpg') }}" alt="home-multi-brand">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-02.html">
                                                    <div class="demo-image position-relative">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-02.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-02.jpg') }}" alt="home-02">
                                                        <div class="demo-label">
                                                            <span class="demo-hot">Hot</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-03.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-03.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-03.jpg') }}" alt="home-03">
                                                    </div>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-04.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-04.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-04.jpg') }}" alt="home-04">
                                                    </div>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-05.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-05.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-05.jpg') }}" alt="home-05">
                                                    </div>
                                            ...
                                            <div class="demo-item">
                                                <a href="home-06.html">
                                                    <div class="demo-image position-relative">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-06.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-06.jpg') }}" alt="home-06">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-personalized-pod.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-personalized-pod.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-personalized-pod.jpg') }}" alt="home-personalized-pod">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-pickleball.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-pickleball.png') }}" src="{{ asset('assets/frontend/images/demo/home-pickleball.png') }}" alt="home-pickleball">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-ceramic.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-ceramic.png') }}" src="{{ asset('assets/frontend/images/demo/home-ceramic.png') }}" alt="home-ceramic">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-food.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-food.png') }}" src="{{ asset('assets/frontend/images/demo/home-food.png') }}" alt="home-food">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="demo-item position-relative">
                                                <a href="home-camp-and-hike.html">
                                                    <div class="demo-image">
                                                        <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-camp-and-hike.png') }}" src="{{ asset('assets/frontend/images/demo/home-camp-and-hike.png') }}" alt="home-camp-and-hike">
                                                        <div class="demo-label">
                                                            <span class="demo-new">New</span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="text-center view-all-demo">
                                            <a href="#modalDemo" data-bs-toggle="modal" class="tf-btn btn-xl btn-fill radius-3 animate-hover-btn fw-6"><span>View all demos (46+)</span><i class="icon icon-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                                ...
                                                <div class="collection-item hover-img">
                                                    <div class="collection-inner">
                                                        <a href="shop-men.html" class="collection-image img-style">
                                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/collections/collection-1.jpg') }}" src="{{ asset('assets/frontend/images/collections/collection-1.jpg') }}" alt="collection-demo-1">
                                                        </a>
                                                ...
                                                <div class="collection-item hover-img">
                                                    <div class="collection-inner">
                                                        <a href="shop-women.html" class="collection-image img-style">
                                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/collections/collection-2.jpg') }}" src="{{ asset('assets/frontend/images/collections/collection-2.jpg') }}" alt="collection-demo-1">
                                                        </a>
                                                        <div class="collection-content">
                                            ...
                                            <div class="col-lg-2">
                                                <div class="mega-menu-item">
                                                    ...
                                                    <ul class="menu-list">
                                                        ...
                                                        <li><a href="product-detail-volume-discount.html" class="menu-link-text link position-relative">Volume Discount<div class="demo-label"><span class="demo-new">New</span></div></a></li>
                                                        <li><a href="product-detail-volume-discount-grid.html" class="menu-link-text link position-relative">Volume Discount Grid<div class="demo-label"><span class="demo-new">New</span></div></a></li>
                                                        <li><a href="product-detail-buyx-gety.html" class="menu-link-text link position-relative">Buy X Get Y<div class="demo-label"><span class="demo-new">New</span></div></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                        ...
                                                        <div class="swiper-wrapper">
                                                                ...
                                                                <div class="card-product">
                                                                    <div class="card-product-wrapper">
                                                                        <a href="#" class="product-img">
                                                                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/orange-1.jpg') }}" src="{{ asset('assets/frontend/images/products/orange-1.jpg') }}" alt="image-product">
                                                                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/white-1.jpg') }}" src="{{ asset('assets/frontend/images/products/white-1.jpg') }}" alt="image-product">
                                                                        </a>
                                                                    ...
                                                                    <div class="card-product-info">
                                                                        ...
                                                                        <ul class="list-color-product">
                                                                            <li class="list-color-item color-swatch active">
                                                                                ...
                                                                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/orange-1.jpg') }}" src="{{ asset('assets/frontend/images/products/orange-1.jpg') }}" alt="image-product">
                                                                            </li>
                                                                            <li class="list-color-item color-swatch">
                                                                                <span class="tooltip">Black</span>
                                                                                <span class="swatch-value bg_dark"></span>
                                                                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/black-1.jpg') }}" src="{{ asset('assets/frontend/images/products/black-1.jpg') }}" alt="image-product">
                                                                            </li>
                                                                            <li class="list-color-item color-swatch">
                                                                                <span class="tooltip">White</span>
                                                                                <span class="swatch-value bg_white"></span>
                                                                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/white-1.jpg') }}" src="{{ asset('assets/frontend/images/products/white-1.jpg') }}" alt="image-product">
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="card-product">
                                                                    <div class="card-product-wrapper">
                                                                        <div class="product-img">
                                                                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/white-3.jpg') }}" src="{{ asset('assets/frontend/images/products/white-3.jpg') }}" alt="image-product">
                                                                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/white-4.jpg') }}" src="{{ asset('assets/frontend/images/products/white-4.jpg') }}" alt="image-product">
                                                                        </div>
                                                                        <div class="list-product-btn absolute-2">
                                                            ...
                                                            <div class="swiper-slide" lazy="true">
                                                                <div class="card-product">
                                                                    <div class="card-product-wrapper">
                                                                        <div class="product-img">
                                                                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/white-2.jpg') }}" src="{{ asset('assets/frontend/images/products/white-2.jpg') }}" alt="image-product">
                                                                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/pink-1.jpg') }}" src="{{ asset('assets/frontend/images/products/pink-1.jpg') }}" alt="image-product">
                                                                        </div>
                                                                    ...
                                                                    <div class="card-product-info">
                                                                        ...
                                                                        <ul class="list-color-product">
                                                                            <li class="list-color-item color-swatch active">
                                                                                <span class="tooltip">White</span>
                                                                                <span class="swatch-value bg_white"></span>
                                                                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/white-2.jpg') }}" src="{{ asset('assets/frontend/images/products/white-2.jpg') }}" alt="image-product">
                                                                            </li>
                                                                            <li class="list-color-item color-swatch">
                                                                                <span class="tooltip">Pink</span>
                                                                                <span class="swatch-value bg_purple"></span>
                                                                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/pink-1.jpg') }}" src="{{ asset('assets/frontend/images/products/pink-1.jpg') }}" alt="image-product">
                                                                            </li>
                                                                            <li class="list-color-item color-swatch">
                                                                                <span class="tooltip">Black</span>
                                                                                <span class="swatch-value bg_dark"></span>
                                                                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/black-2.jpg') }}" src="{{ asset('assets/frontend/images/products/black-2.jpg') }}" alt="image-product">
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="swiper-slide" lazy="true">
                                                                <div class="card-product">
                                                                    <div class="card-product-wrapper">
                                                                        <div class="product-img">
                                                                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/brown-2.jpg') }}" src="{{ asset('assets/frontend/images/products/brown-2.jpg') }}" alt="image-product">
                                                                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/brown-3.jpg') }}" src="{{ asset('assets/frontend/images/products/brown-3.jpg') }}" alt="image-product">
                                                                        </div>
                                                                        <div class="size-list">
                                                                            <span>S</span>
                                                                            <span>M</span>
                                                                    ...
                                                                    <div class="card-product-info">
                                                                        ...
                                                                        <ul class="list-color-product">
                                                                            <li class="list-color-item color-swatch active">
                                                                                ...
                                                                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/brown-2.jpg') }}" src="{{ asset('assets/frontend/images/products/brown-2.jpg') }}" alt="image-product">
                                                                            </li>
                                                                            <li class="list-color-item color-swatch">
                                                                                <span class="tooltip">White</span>
                                                                                <span class="swatch-value bg_white"></span>
                                                                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/white-5.jpg') }}" src="{{ asset('assets/frontend/images/products/white-5.jpg') }}" alt="image-product">
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="wrap-slider">
                        <img src="{{ asset('assets/frontend/images/slider/fashion-slideshow-01.jpg') }}" alt="fashion-slideshow">
                ...
                <div class="swiper-slide">
                    <div class="wrap-slider">
                        <img src="{{ asset('assets/frontend/images/slider/fashion-slideshow-02.jpg') }}" alt="fashion-slideshow">
                        <div class="box-content">
                            <div class="container">
                ...
                <div class="swiper-slide">
                    <div class="wrap-slider">
                        <img src="{{ asset('assets/frontend/images/slider/fashion-slideshow-03.jpg') }}" alt="fashion-slideshow">
                        <div class="box-content">
                            <div class="container">
                                <h1 class="fade-item fade-item-1">Glamorous<br>Glam</h1>
                                <p class="fade-item fade-item-2">From casual to formal, we've got you covered</p>
                        ...
                        <div class="swiper-wrapper">
                                ...
                                <div class="collection-item style-left hover-img">
                                    <div class="collection-inner">
                                        <a href="shop-default.html" class="collection-image img-style">
                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/collections/collection-17.jpg') }}" src="{{ asset('assets/frontend/images/collections/collection-17.jpg') }}" alt="collection-img">
                                        </a>
                                        <div class="collection-content">
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item style-left hover-img">
                                    <div class="collection-inner">
                                        <a href="shop-default.html" class="collection-image img-style">
                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/collections/collection-14.jpg') }}" src="{{ asset('assets/frontend/images/collections/collection-14.jpg') }}" alt="collection-img">
                                        </a>
                                        <div class="collection-content">
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item style-left hover-img">
                                    <div class="collection-inner">
                                        <a href="shop-default.html" class="collection-image img-style">
                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/collections/collection-18.jpg') }}" src="{{ asset('assets/frontend/images/collections/collection-18.jpg') }}" alt="collection-demo-1">
                                        </a>
                                        <div class="collection-content">
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item style-left hover-img">
                                    <div class="collection-inner">
                                        <a href="shop-default.html" class="collection-image img-style">
                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/collections/collection-15.jpg') }}" src="{{ asset('assets/frontend/images/collections/collection-15.jpg') }}" alt="collection-demo-1">
                                        </a>
                                        <div class="collection-content">
                            ...
                            <div class="swiper-slide" lazy="true">
                                <div class="collection-item style-left hover-img">
                                    <div class="collection-inner">
                                        <a href="shop-default.html" class="collection-image img-style">
                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/collections/collection-20.jpg') }}" src="{{ asset('assets/frontend/images/collections/collection-20.jpg') }}" alt="collection-demo-1">
                                        </a>
                                        <div class="collection-content">
        ...
        <div class="container">
            ...
            <div class="grid-layout loadmore-item wow fadeInUp" data-wow-delay="0s" data-grid="grid-4">
                ...
                <div class="card-product fl-item">
                    <div class="card-product-wrapper">
                        <a href="product-detail.html" class="product-img">
                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/brown.jpg') }}" src="{{ asset('assets/frontend/images/products/brown.jpg') }}" alt="image-product">
                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/purple.jpg') }}" src="{{ asset('assets/frontend/images/products/purple.jpg') }}" alt="image-product">
                        </a>
                        <div class="list-product-btn">
                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                <span class="icon icon-bag"></span>
                    ...
                    <div class="card-product-info">
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                <span class="tooltip">Brown</span>
                                <span class="swatch-value bg_brown"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/brown.jpg') }}" src="{{ asset('assets/frontend/images/products/brown.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Light Purple</span>
                                <span class="swatch-value bg_purple"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/purple.jpg') }}" src="{{ asset('assets/frontend/images/products/purple.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Light Green</span>
                                <span class="swatch-value bg_light-green"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/green.jpg') }}" src="{{ asset('assets/frontend/images/products/green.jpg') }}" alt="image-product">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-product fl-item">
                    <div class="card-product-wrapper">
                        <a href="product-detail.html" class="product-img">
                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/light-green-1.jpg') }}" src="{{ asset('assets/frontend/images/products/light-green-1.jpg') }}" alt="image-product">
                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/light-green-2.jpg') }}" src="{{ asset('assets/frontend/images/products/light-green-2.jpg') }}" alt="image-product">
                        </a>
                        <div class="list-product-btn absolute-2">
                            <a href="#quick_add" data-bs-toggle="modal" class="box-icon bg_white quick-add tf-btn-loading">
                                <span class="icon icon-bag"></span>
                    ...
                    <div class="card-product-info">
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                <span class="tooltip">Light Green</span>
                                <span class="swatch-value bg_light-green"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/light-green-1.jpg') }}" src="{{ asset('assets/frontend/images/products/light-green-1.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Black</span>
                                <span class="swatch-value bg_dark"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/black-3.jpg') }}" src="{{ asset('assets/frontend/images/products/black-3.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Blue</span>
                                <span class="swatch-value bg_blue-2"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/blue.jpg') }}" src="{{ asset('assets/frontend/images/products/blue.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Dark Blue</span>
                                <span class="swatch-value bg_dark-blue"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/dark-blue.jpg') }}" src="{{ asset('assets/frontend/images/products/dark-blue.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">White</span>
                                <span class="swatch-value bg_white"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/white-6.jpg') }}" src="{{ asset('assets/frontend/images/products/white-6.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Light Grey</span>
                                <span class="swatch-value bg_light-grey"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/light-grey.jpg') }}" src="{{ asset('assets/frontend/images/products/light-grey.jpg') }}" alt="image-product">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-product fl-item">
                    <div class="card-product-wrapper">
                        <a href="product-detail.html" class="product-img">
                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/black-4.jpg') }}" src="{{ asset('assets/frontend/images/products/black-4.jpg') }}" alt="image-product">
                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/black-5.jpg') }}" src="{{ asset('assets/frontend/images/products/black-5.jpg') }}" alt="image-product">
                        </a>
                        <div class="size-list">
                            <span>S</span>
                            <span>M</span>
                    ...
                    <div class="card-product-info">
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                <span class="tooltip">Black</span>
                                <span class="swatch-value bg_dark"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/black-4.jpg') }}" src="{{ asset('assets/frontend/images/products/black-4.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Dark Blue</span>
                                <span class="swatch-value bg_dark-blue"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/dark-blue-2.jpg') }}" src="{{ asset('assets/frontend/images/products/dark-blue-2.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Beige</span>
                                <span class="swatch-value bg_beige"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/beige.jpg') }}" src="{{ asset('assets/frontend/images/products/beige.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Light Blue</span>
                                <span class="swatch-value bg_light-blue"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/light-blue.jpg') }}" src="{{ asset('assets/frontend/images/products/light-blue.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">White</span>
                                <span class="swatch-value bg_white"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/white-7.jpg') }}" src="{{ asset('assets/frontend/images/products/white-7.jpg') }}" alt="image-product">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-product fl-item">
                    <div class="card-product-wrapper">
                        <a href="product-detail.html" class="product-img">
                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/white-8.jpg') }}" src="{{ asset('assets/frontend/images/products/white-8.jpg') }}" alt="image-product">
                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/black-6.jpg') }}" src="{{ asset('assets/frontend/images/products/black-6.jpg') }}" alt="image-product">
                        </a>
                        <div class="size-list">
                            <span>S</span>
                            <span>M</span>
                    ...
                    <div class="card-product-info">
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                <span class="tooltip">White</span>
                                <span class="swatch-value bg_white"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/white-8.jpg') }}" src="{{ asset('assets/frontend/images/products/white-8.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Black</span>
                                <span class="swatch-value bg_dark"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/black-7.jpg') }}" src="{{ asset('assets/frontend/images/products/black-7.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Blue</span>
                                <span class="swatch-value bg_blue-2"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/blue-2.jpg') }}" src="{{ asset('assets/frontend/images/products/blue-2.jpg') }}" alt="image-product">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-product fl-item">
                    <div class="card-product-wrapper">
                        <a href="product-detail.html" class="product-img">
                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/brown-4.jpg') }}" src="{{ asset('assets/frontend/images/products/brown-4.jpg') }}" alt="image-product">
                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/black-8.jpg') }}" src="{{ asset('assets/frontend/images/products/black-8.jpg') }}" alt="image-product">
                        </a>
                        <div class="size-list">
                            <span>M</span>
                            <span>L</span>
                    ...
                    <div class="card-product-info">
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                <span class="tooltip">Brown</span>
                                <span class="swatch-value bg_brown"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/brown-4.jpg') }}" src="{{ asset('assets/frontend/images/products/brown-4.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Black</span>
                                <span class="swatch-value bg_dark"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/black-8.jpg') }}" src="{{ asset('assets/frontend/images/products/black-8.jpg') }}" alt="image-product">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-product fl-item">
                    <div class="card-product-wrapper">
                        <a href="product-detail.html" class="product-img">
                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/black-9.jpg') }}" src="{{ asset('assets/frontend/images/products/black-9.jpg') }}" alt="image-product">
                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/black-10.jpg') }}" src="{{ asset('assets/frontend/images/products/black-10.jpg') }}" alt="image-product">
                        </a>
                        <div class="size-list">
                            <span>S</span>
                            <span>M</span>
                    ...
                    <div class="card-product-info">
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                <span class="tooltip">Black</span>
                                <span class="swatch-value bg_dark"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/black-9.jpg') }}" src="{{ asset('assets/frontend/images/products/black-9.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Black</span>
                                <span class="swatch-value bg_white"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/white-9.jpg') }}" src="{{ asset('assets/frontend/images/products/white-9.jpg') }}" alt="image-product">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-product fl-item">
                    <div class="card-product-wrapper">
                        <a href="product-detail.html" class="product-img">
                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/grey-2.jpg') }}" src="{{ asset('assets/frontend/images/products/grey-2.jpg') }}" alt="image-product">
                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/grey.jpg') }}" src="{{ asset('assets/frontend/images/products/grey.jpg') }}" alt="image-product">
                        </a>
                        <div class="size-list">
                            <span>S</span>
                            <span>M</span>
                    ...
                    <div class="card-product-info">
                        ...
                        <ul class="list-color-product">
                            <li class="list-color-item color-swatch active">
                                ...
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/grey-2.jpg') }}" src="{{ asset('assets/frontend/images/products/grey-2.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Pink</span>
                                <span class="swatch-value bg_pink"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/pink-2.jpg') }}" src="{{ asset('assets/frontend/images/products/pink-2.jpg') }}" alt="image-product">
                            </li>
                            <li class="list-color-item color-swatch">
                                <span class="tooltip">Light Pink</span>
                                <span class="swatch-value bg_light-pink"></span>
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/products/light-pink.jpg') }}" src="{{ asset('assets/frontend/images/products/light-pink.jpg') }}" alt="image-product">
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card-product fl-item">
                    <div class="card-product-wrapper">
                        <a href="product-detail.html" class="product-img">
                            <img class="lazyload img-product" data-src="{{ asset('assets/frontend/images/products/black-11.jpg') }}" src="{{ asset('assets/frontend/images/products/black-11.jpg') }}" alt="image-product">
                            <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/products/black-12.jpg') }}" src="{{ asset('assets/frontend/images/products/black-12.jpg') }}" alt="image-product">
                        </a>
                        <div class="size-list">
                            <span>S</span>
                            <span>M</span>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide" lazy="true">
                    <div class="wrap-lookbook lookbook-1">
                        <div class="image">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/shop/file/lookbook-3.jpg') }}" src="{{ asset('assets/frontend/images/shop/file/lookbook-3.jpg') }}" alt="image-lookbook">
                        </div>
                                        ...
                                        <li>
                                            <div class="lookbook-product">
                                                <a href="product-detail.html" class="image">
                                                    <img class="lazyload" data-src="{{ asset('assets/frontend/images/shop/products/img-p2.png') }}" src="{{ asset('assets/frontend/images/shop/products/img-p2.png') }}" alt="lookbook-item">
                                                </a>
                                ...
                                <div class="btn-group dropdown dropup dropdown-center">
                                    ...
                                    <ul class="dropdown-menu p-0 border-0">
                                        <li>
                                            <div class="lookbook-product">
                                                <a href="product-detail.html" class="image">
                                                    <img class="lazyload" data-src="{{ asset('assets/frontend/images/shop/products/img-p4.png') }}" src="{{ asset('assets/frontend/images/shop/products/img-p4.png') }}" alt="">
                                                </a>
                                                <div class="content-wrap">
                                                    <div class="product-title">
                ...
                <div class="swiper-slide" lazy="true">
                    <div class="wrap-lookbook lookbook-2">
                        <div class="image">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/shop/file/lookbook-4.jpg') }}" src="{{ asset('assets/frontend/images/shop/file/lookbook-4.jpg') }}" alt="image-lookbook">
                        </div>
                        <div class="lookbook-item item-1">
                            <div class="inner">
                                <div class="btn-group dropdown dropup dropdown-center">
                                    ...
                                    <ul class="dropdown-menu p-0 border-0">
                                        <li>
                                            <div class="lookbook-product">
                                                <a href="product-detail.html" class="image">
                                                    <img class="lazyload" data-src="{{ asset('assets/frontend/images/shop/products/img-p5.png') }}" src="{{ asset('assets/frontend/images/shop/products/img-p5.png') }}" alt="">
                                                </a>
                                                <div class="content-wrap">
                                                    <div class="product-title">
                                ...
                                <div class="product">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/shop/products/img-p2.png') }}" src="{{ asset('assets/frontend/images/shop/products/img-p2.png') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="content-wrap">
                                        <div class="product-title">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item style-column wow fadeInUp" data-wow-delay=".1s">
                                ...
                                <div class="product">
                                    <div class="image">
                                        <a href="product-detail.html">
                                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/shop/products/img-p3.png') }}" src="{{ asset('assets/frontend/images/shop/products/img-p3.png') }}" alt="">
                                        </a>
                                    </div>
                                    <div class="content-wrap">
                                        <div class="product-title">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="brand-item">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/brand/brand-01.png') }}" src="{{ asset('assets/frontend/images/brand/brand-01.png') }}" alt="image-brand">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-item">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/brand/brand-02.png') }}" src="{{ asset('assets/frontend/images/brand/brand-02.png') }}" alt="image-brand">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-item">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/brand/brand-03.png') }}" src="{{ asset('assets/frontend/images/brand/brand-03.png') }}" alt="image-brand">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-item">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/brand/brand-04.png') }}" src="{{ asset('assets/frontend/images/brand/brand-04.png') }}" alt="image-brand">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-item">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/brand/brand-05.png') }}" src="{{ asset('assets/frontend/images/brand/brand-05.png') }}" alt="image-brand">
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="brand-item">
                            <img class="lazyload" data-src="{{ asset('assets/frontend/images/brand/brand-06.png') }}" src="{{ asset('assets/frontend/images/brand/brand-06.png') }}" alt="image-brand">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".2s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/shop/gallery/gallery-7.jpg') }}" src="{{ asset('assets/frontend/images/shop/gallery/gallery-7.jpg') }}" alt="image-gallery">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".3s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/shop/gallery/gallery-3.jpg') }}" src="{{ asset('assets/frontend/images/shop/gallery/gallery-3.jpg') }}" alt="image-gallery">
                                </div>
                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".4s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/shop/gallery/gallery-5.jpg') }}" src="{{ asset('assets/frontend/images/shop/gallery/gallery-5.jpg') }}" alt="image-gallery">
                                </div>
                                <a href="#quick_add" data-bs-toggle="modal" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">Quick Add</span></a>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".5s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/shop/gallery/gallery-8.jpg') }}" src="{{ asset('assets/frontend/images/shop/gallery/gallery-8.jpg') }}" alt="image-gallery">
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="gallery-item hover-img wow fadeInUp" data-wow-delay=".6s">
                                <div class="img-style">
                                    <img class="lazyload img-hover" data-src="{{ asset('assets/frontend/images/shop/gallery/gallery-6.jpg') }}" src="{{ asset('assets/frontend/images/shop/gallery/gallery-6.jpg') }}" alt="image-gallery">
                                </div>
                                <a href="product-detail.html" class="box-icon"><span class="icon icon-bag"></span> <span class="tooltip">View product</span></a>
                            </div>
                        </div>
            ...
            <div class="mega-menu">
                <div class="row-demo">
                    ...
                    <div class="demo-item">
                        <a href="home-07.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-07.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-07.jpg') }}" alt="home-07">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-08.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-08.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-08.jpg') }}" alt="home-08">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-skincare.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-skincare.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-skincare.jpg') }}" alt="home-skincare">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-headphone.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-headphone.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-headphone.jpg') }}" alt="home-headphone">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-giftcard.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-giftcard.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-giftcard.jpg') }}" alt="home-gift-card">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-furniture.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-furniture.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-furniture.jpg') }}" alt="home-furniture">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-furniture-02.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-furniture2.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-furniture2.jpg') }}" alt="home-furniture-2">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-skateboard.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-skateboard.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-skateboard.jpg') }}" alt="home-skateboard">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-stroller.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-stroller.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-stroller.jpg') }}" alt="home-stroller">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-decor.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-decor.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-decor.jpg') }}" alt="home-decor">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-electronic.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-electronic.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-electronic.jpg') }}" alt="home-electronic">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-setup-gear.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-setup-gear.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-setup-gear.jpg') }}" alt="home-setup-gear">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-dog-accessories.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-dog-accessories.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-dog-accessories.jpg') }}" alt="home-dog-accessories">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-kitchen-wear.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-kitchen.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-kitchen.jpg') }}" alt="home-kitchen-wear">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-phonecase.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-phonecase.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-phonecase.jpg') }}" alt="home-phonecase">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-paddle-boards.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home_paddle_board.jpg') }}" src="{{ asset('assets/frontend/images/demo/home_paddle_board.jpg') }}" alt="home-paddle_board">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-glasses.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-glasses.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-glasses.jpg') }}" alt="home-glasses">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-pod-store.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-pod-store.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-pod-store.jpg') }}" alt="home-pod-store">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-activewear.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-activewear.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-activewear.jpg') }}" alt="home-activewear">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-handbag.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-handbag.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-handbag.jpg') }}" alt="home-handbag">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-tee.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-tee.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-tee.jpg') }}" alt="home-tee">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-sock.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-socks.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-socks.jpg') }}" alt="home-sock">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-jewerly.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-jewelry.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-jewelry.jpg') }}" alt="home-jewelry">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-sneaker.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-sneaker.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-sneaker.jpg') }}" alt="home-sneaker">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-accessories.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-accessories.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-accessories.jpg') }}" alt="home-accessories">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-grocery.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-gocery.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-gocery.jpg') }}" alt="home-grocery">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-baby.html">
                            <div class="demo-image">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-baby.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-baby.jpg') }}" alt="home-baby">
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-cosmetic.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-cosmetic.png') }}" src="{{ asset('assets/frontend/images/demo/home-cosmetic.png') }}" alt="home-cosmetic">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-plant.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-plant.png') }}" src="{{ asset('assets/frontend/images/demo/home-plant.png') }}" alt="home-plant">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-swimwear.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-swimwear.png') }}" src="{{ asset('assets/frontend/images/demo/home-swimwear.png') }}" alt="home-swimwear">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-electric-bike.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-electric-bike.png') }}" src="{{ asset('assets/frontend/images/demo/home-electric-bike.png') }}" alt="home-electric-bike">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-footwear.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-footwear.jpg') }}" src="{{ asset('assets/frontend/images/demo/home-footwear.jpg') }}" alt="home-footwear">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-book-store.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-bookstore.png') }}" src="{{ asset('assets/frontend/images/demo/home-bookstore.png') }}" alt="home-bookstore">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                    ...
                    <div class="demo-item">
                        <a href="home-gaming-accessories.html">
                            <div class="demo-image position-relative">
                                <img class="lazyload" data-src="{{ asset('assets/frontend/images/demo/home-gaming-accessories.png') }}" src="{{ asset('assets/frontend/images/demo/home-gaming-accessories.png') }}" alt="home-gaming-accessories">
                                <div class="demo-label">
                                    <span class="demo-new">New</span>
                                </div>
                            </div>
                ...
                <li class="nav-mb-item">
                    ...
                    <div id="dropdown-menu-one" class="collapse">
                        <ul class="sub-nav-menu" >
                            <li><a href="index-2.html" class="sub-nav-link">Home Fashion 01</a></li>
                    ...
                    <div class="tf-col-content">
                        ...
                        <div class="tf-search-hidden-inner">
                            <div class="tf-loop-item">
                                <div class="image">
                                    <a href="product-detail.html">
                                        <img src="{{ asset('assets/frontend/images/products/white-3.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="content">
                                    <a href="product-detail.html">Cotton jersey top</a>
                            ...
                            <div class="tf-loop-item">
                                <div class="image">
                                    <a href="product-detail.html">
                                        <img src="{{ asset('assets/frontend/images/products/white-2.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="content">
                            ...
                            <div class="tf-loop-item">
                                <div class="image">
                                    <a href="product-detail.html">
                                        <img src="{{ asset('assets/frontend/images/products/white-1.jpg') }}" alt="">
                                    </a>
                                </div>
                                <div class="content">
            ...
            <ul class="nav-ul-mb" id="wrapper-menu-navigation">
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{ asset('assets/frontend/images/shop/cate/cate1.jpg') }}" alt="">
                        </div>
                ...
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{ asset('assets/frontend/images/shop/cate/cate2.jpg') }}" alt="">
                        </div>
                        <span>Dog</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{ asset('assets/frontend/images/shop/cate/cate3.jpg') }}" alt="">
                        </div>
                        <span>Grocery</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="shop-default.html" class="tf-category-link mb-menu-link">
                        <div class="image">
                            <img src="{{ asset('assets/frontend/images/shop/cate/cate4.png') }}" alt="">
                        </div>
                        <span>Handbag</span>
                    </a>
                </li>
                <li class="nav-mb-item">
                    <a href="#cate-menu-one" class="tf-category-link has-children collapsed mb-menu-link" data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-menu-one">
                        <div class="image">
                            <img src="{{ asset('assets/frontend/images/shop/cate/cate5.jpg') }}" alt="">
                        </div>
                        <span>Fashion</span>
                        <span class="btn-open-sub"></span>
                    </a>
                        ...
                        <ul class="sub-nav-menu" id="cate-menu-navigation">
                            <li>
                                <a href="#cate-shop-one" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-one">
                                    <div class="image">
                                        <img src="{{ asset('assets/frontend/images/shop/cate/cate6.jpg') }}" alt="">
                                    </div>
                                    <span>Mens</span>
                                    <span class="btn-open-sub"></span>
                                </a>
                                <div id="cate-shop-one" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        ...
                                        <li>
                                            <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                <div class="image">
                                                    <img src="{{ asset('assets/frontend/images/shop/cate/cate8.jpg') }}" alt="">
                                                </div>
                                                <span>Shoes</span>
                                            </a>
                                        </li>
                            ...
                            <li>
                                <a href="#cate-shop-two" class="tf-category-link has-children sub-nav-link collapsed"  data-bs-toggle="collapse" aria-expanded="true" aria-controls="cate-shop-two">
                                    <div class="image">
                                        <img src="{{ asset('assets/frontend/images/shop/cate/cate9.jpg') }}" alt="">
                                    </div>
                                    <span>Womens</span>
                                    <span class="btn-open-sub"></span>
                                </a>
                                <div id="cate-shop-two" class="collapse">
                                    <ul class="sub-nav-menu sub-menu-level-2">
                                        ...
                                        <li>
                                            <a href="shop-default.html" class="tf-category-link sub-nav-link">
                                                <div class="image">
                                                    <img src="{{ asset('assets/frontend/images/shop/cate/cate7.jpg') }}" alt="">
                                                </div>
                                                <span>Tee</span>
                                            </a>
                                        </li>
                            ...
                            <div class="tf-compare-offcanvas">
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="product-detail.html">
                                            <img class="radius-3" src="{{ asset('assets/frontend/images/products/orange-1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                                <div class="tf-compare-item">
                                    <div class="position-relative">
                                        ...
                                        <a href="product-detail.html">
                                            <img class="radius-3" src="{{ asset('assets/frontend/images/products/pink-1.jpg') }}" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <div class="wrap">
                <div class="tf-product-info-item">
                    <div class="image">
                        <img src="{{ asset('assets/frontend/images/products/orange-1.jpg') }}" alt="">
                    </div>
                    <div class="content">
                ...
                <div class="tf-product-info-buy-button">
                    <form>
                        ...
                        <div class="w-100">
                            <a href="#" class="btns-full">Buy with <img src="{{ asset('assets/frontend/images/payments/paypal.png') }}" alt=""></a>
                ...
                <div class="tf-product-media-wrap">
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper" >
                            ...
                            <div class="swiper-slide">
                                <div class="item">
                                    <img src="{{ asset('assets/frontend/images/products/pink-1.jpg') }}" alt="">
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="tf-rte">
                ...
                <div class="tf-page-size-chart-content">
                    ...
                    <div>
                        <img class="sizechart lazyload" data-src="{{ asset('assets/frontend/images/shop/products/size_chart2.jpg') }}" src="{{ asset('assets/frontend/images/shop/products/size_chart2.jpg') }}" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal modalCentered fade auto-popup modal-newleter">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-top">
                <img class="lazyload" data-src="{{ asset('assets/frontend/images/item/banner-newleter.jpg') }}" src="{{ asset('assets/frontend/images/item/banner-newleter.jpg') }}" alt="home-01">
