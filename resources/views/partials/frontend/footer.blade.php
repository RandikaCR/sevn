                    ...
                    <div class="col-xl-3 col-md-6 col-12">
                        <div class="footer-infor">
                            <div class="footer-logo">
                                <a href="index-2.html">
                                    <img src="{{ asset('assets/frontend/images/logo/logo.svg') }}" alt="">
                                </a>
                            </div>
                            <ul>
                                <li>
                    ...
                    <div class="col-12">
                        <div class="footer-bottom-wrap d-flex gap-20 flex-wrap justify-content-between align-items-center">
                            ...
                            <div class="tf-payment">
                                <img src="{{ asset('assets/frontend/images/payments/visa.png') }}" alt="">
                                    <img src="{{ asset('assets/frontend/images/payments/img-1.png') }}" alt="">
                                    <img src="{{ asset('assets/frontend/images/payments/img-2.png') }}" alt="">
                                    <img src="{{ asset('assets/frontend/images/payments/img-3.png') }}" alt="">
                                    <img src="{{ asset('assets/frontend/images/payments/img-4.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
