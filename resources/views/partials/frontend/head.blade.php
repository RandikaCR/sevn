...
<title>@yield('page_title') :: SEVN</title>
...
<link rel="stylesheet" href="{{ asset('assets/frontend/css/sib-styles.css') }}">
...
<link rel="apple-touch-icon-precomposed" href="{{ asset('assets/frontend/images/logo/favicon.png') }}">
